...
const cargar_filtros = async()=>{
    ...
    const res = await fetch('https://pruebabsa.herokuapp.com/php/cargar_filtros.php');
...
const buscar_items = async(posicion)=>{
    ...
    const res = await fetch('https://pruebabsa.herokuapp.com/php/cargar_filtros.php/buscar_items.php',{
        method:'POST',
...
const cargar_items = async()=>{
    ...
    const res = await fetch('https://pruebabsa.herokuapp.com/php/cargar_filtros.php/cargar_items.php');
    const data =  JSON.parse(await res.text());
